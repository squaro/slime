...
const es: typeof strings = {
  ...
  LANG_EN_US: 'Inglés',
  LANG_ES_ES: 'Español',
  LANGUAGE_MODAL_CLOSE_BUTTON: 'Cerrar',
  ...
  WAKE_LOCK_MODAL_PHONE: 'Puedes determinar si tu teléfono admite esta funcionalidad o no mirando la parte superior de la pantalla.',
  WAKE_LOCK_MODAL_SUPPORT: 'Si su teléfono no admite la funcionalidad Wake Lock, pronto podrá informar el problema.',
